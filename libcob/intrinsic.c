...
#endif
		;
	const unsigned long COB_PI_PREC = 2820UL;

	mpf_init2 (cob_pi, COB_PI_PREC);
...
#endif
		;
	const unsigned long COB_SQRT_TWO_PREC = 3827UL;

	mpf_init2 (cob_sqrt_two, COB_SQRT_TWO_PREC);
...
#endif
		;
	const unsigned long COB_LOG_HALF_PREC = 2784UL;

	mpf_init2 (cob_log_half, COB_LOG_HALF_PREC);
